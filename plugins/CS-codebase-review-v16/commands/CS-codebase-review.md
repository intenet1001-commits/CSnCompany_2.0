...
# src 디렉토리만 분석
/experiencing review src/

# 보안 관점만 집중 분석
/experiencing review --focus security

# 특정 경로의 성능만 분석
/experiencing review src/api --focus performance
```
...
이 커맨드는 `skills/CS-codebase-review/SKILL.md`의 프로토콜을 따릅니다.
